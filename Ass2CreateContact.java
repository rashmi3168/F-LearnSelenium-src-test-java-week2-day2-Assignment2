...
public class Ass2CreateContact {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@id='firstNameField']")).sendKeys("Rashmi");
		driver.findElement(By.xpath("//input[@id='lastNameField']")).sendKeys("Bhatt");
		...
		driver.findElement(By.xpath("//input[@id='createContactForm_primaryEmail']")).sendKeys("rashmi3168@gmail.com");
